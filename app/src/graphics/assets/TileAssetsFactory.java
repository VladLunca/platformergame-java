...
public class TileAssetsFactory implements AssetsFactory{
    ...
    public void load(Map<String, BufferedImage[]> images) {
        SpriteSheet level1 = new SpriteSheet(ImageLoader.LoadImage("/textures/maps/grass_tileset.png"));
        ...
        SpriteSheet level2 = new SpriteSheet(ImageLoader.LoadImage("/textures/maps/castle_tileset.png"));
        ...
        SpriteSheet level3 = new SpriteSheet(ImageLoader.LoadImage("/textures/maps/night_tileset.png"));
